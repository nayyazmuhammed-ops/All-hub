--[[ 
    KING PERFORMANCE | MOONSEC V3.3.1 OBFUSCATED 
    Authorized: zayan
]]

--// THE UNCRASHABLE MOONSEC ENGINE
local function King_Protocol()
    local S = game:GetService("StarterGui")
    -- Encrypted byte-strings for that Moonsec look
    local B = {
        '\73\110\105\116\105\97\108\105\122\105\110\103\32\75\105\110\103\32\86\51',
        '\66\121\112\97\115\115\105\110\103\32\83\101\99\117\114\105\116\121',
        '\76\111\97\100\105\110\103\32\77\97\116\104\32\77\111\100\117\108\101\115',
        '\65\117\116\104\111\114\105\122\101\100\58\32\122\97\121\97\110'
    }
    pcall(function()
        for _, v in ipairs(B) do
            local h = "" for _=1,10 do h=h..string.format("%X",math.random(0,15))end
            print("["..h.."] "..v)
            S:SetCore("SendNotification", {Title = "🛡️ MOONSEC V3", Text = v, Duration = 1})
            task.wait(0.2)
        end
    end)
end
...
--// 7. GROW A GARDEN (LUMIN + THUNDER + SPEED)
